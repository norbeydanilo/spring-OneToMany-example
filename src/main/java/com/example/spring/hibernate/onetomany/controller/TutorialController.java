...
import com.example.spring.hibernate.onetomany.repository.TutorialRepository;

//import static com.bezkoder.spring.hibernate.onetomany.controller.Response.NOT_FOUND;
...
public class TutorialController {
  ...
  public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(required = false) String title) {
    ...
    if (tutorials.isEmpty()) {
      ...
      return new ResponseEntity<>(_tutorials, HttpStatus.NO_CONTENT);
    }
  ...
  public ResponseEntity<Response> deleteTutorial(@PathVariable("id") long id) {
    if (!tutorialRepository.existsById(id)) {
      throw new ResourceNotFoundException("Not found Tutorial with id = " + id);
    }

    tutorialRepository.deleteById(id);
    return new ResponseEntity<>(Response.noErrorResponse(), HttpStatus.NO_CONTENT);
  }
